...
export function SearchCompanyCard({ image, title, category }: JobCardProps) {
  return (
    <Col lg={7} md={12} xs={12}>
      <Paper
        radius='md'
        className='w-full h-44 bg-slate-100 dark:bg-gray-800 cursor-pointer shadow-md hover:shadow-lg transition-all lg:p-6 p-4'
      >
