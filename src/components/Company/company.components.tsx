    ...
    <div className='company-main-title-container'>
      <div className='company-main-title'>
        <div className='company-title-container'>
          ...
          <div>
            <p className='text-gray-900 dark:text-zinc-100 lg:text-lg font-bold text-sm'>
              Company Name
            </p>
            <p className='text-gray-700 dark:text-zinc-100 lg:text-sm text-xs'>
